...
const DICT = {
  zh: {
    ...
    history_best: "历史最佳",
    level_best: "本关最佳",
    leaderboard_title: "个人战绩排行榜",
    leaderboard_empty: "暂无历史战绩，挑战后将在此上榜！",
    new_record_cheer: "🏆 刷新个人历史最高纪录！",
    target_beat: "🎯 挑战目标：打破历史纪录 {score} 分",
    first_challenge: "✨ 首次挑战该项目：创造你的第一个纪录吧！",
    diff_to_best: "距历史最佳还差 {diff} 分",
    rank_n: "第 {n} 名",
    score_unit: "分",
    hud_accuracy: "正确率",
    hud_avg_rt: "平均反应时",
  ...
  en: {
    ...
    best: "Highest Level",
    history_best: "Personal Best",
    level_best: "Level Best",
    leaderboard_title: "Personal Leaderboard",
    leaderboard_empty: "No record yet. Set your first benchmark!",
    new_record_cheer: "🏆 NEW PERSONAL RECORD!",
    target_beat: "🎯 Target: Beat record {score} pts",
    first_challenge: "✨ First Attempt: Set your benchmark record!",
    diff_to_best: "{diff} pts to Personal Best",
    rank_n: "#{n}",
    score_unit: "pts",
